...
Nella figura seguente è presente una bozza riassuntiva dalla \textit{board} di progetto ClickUp.

\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.65\textwidth]{images/riass_componenti.png}
