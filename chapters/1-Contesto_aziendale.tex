...
\begin{itemize}
  \item Valutazione e controllo progetti
    ...
    \begin{itemize}
      ...
      \item Utilizzo di metodologie \sacr{oo} per progettazione di applicazioni e processi e UML, con supporto di strumenti di \textit{modeling}, applicazione e definizione di \textit{Design Pattern}.
    \end{itemize}
\end{itemize}
